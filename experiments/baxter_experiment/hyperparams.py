...
from gps.agent.ros.agent_baxter import AgentROS
...
for i in xrange(common['conditions']):
    ...
    ja_x0, ee_pos_x0, ee_rot_x0 = load_pose_from_npz(
        common['target_filename'], 'trial_arm', str(i), 'initial'         # 'trial_arm_0_initial_ja'
    )
    ja_aux, pos_aux, rot_aux = load_pose_from_npz(
